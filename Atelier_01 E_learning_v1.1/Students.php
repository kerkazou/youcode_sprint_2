                                    ...
                                    echo '<tr>
                                            ...
                                            <td class="bg-white">
                                                <div class="d-flex justify-content-around">
                                                    <a href="edit-student.php?id='.$student['id'].'"><i class="bi bi-pencil btn text-info"></i></a>
                                                    <a href="delet-student.php?id='.$student['id'].'"><i class="bi bi-trash btn text-info"></i></a>
                                                </div>
                                            </td>
                                        </tr>';
                                }
