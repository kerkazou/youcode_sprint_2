                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <form method="POST" class="d-flex">
                            ...
                            <button type="button" class="btn text-light px-4 btn-info" style="background-color: #00C1FE;" data-bs-toggle="modal" data-bs-target="#exampleModal">ADD NEW COURSES</button>
                            <?php
