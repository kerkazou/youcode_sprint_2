    ...
    <section class="py-5 vh-100" style="background-image: linear-gradient(50deg,#00C1FE,#FAFFC1);">
        <div class="container bg-white col-md-4 p-4 mt-5" style="border-radius: 20px;">
            ...
            <form method="POST" action="conn_session.php">
                ...
                <button type="submit" name="submit" class="btn text-white w-100 mt-5" style="background-color: #00C1FE;">SIN IN</button>
            </form>
            <p class="mt-5 text-center">Forget your password? <span class="btn btn-link" style="color: #00C1FE;">Reset Password</span></p>
        </div>
    </section>
</body>
</html>