<?php
    ...
    if($compte){
        ...
        setcookie('email' , $_SESSION['email'] , time() + 60 , null , null , false , true);
        setcookie('password' , $_SESSION['password'] , time() + 60 , null , null , false , true);
        header("location:Dashboard.php");
    }else{
        header("location:index.php?error=Your email or password is incorrect");
    }
    if(isset($_POST['checked'])){
        setcookie('emailr' , $_SESSION['email'] , time() + 60*2 , null , null , false , true);
        setcookie('passwordr' , $_SESSION['password'] , time() + 60*2 , null , null , false , true);
